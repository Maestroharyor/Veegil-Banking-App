    ...
    >
      <div className="h-[calc(100vh-52px)] bg-gray-100 dark:bg-dark flex flex-col items-center justify-center gap-10">
        ...
        <div className="text-center pb-6 max-w-[700px] px-5">
          ...
          <Link href="/" passHref>
            <a className="md:col-span-3 px-5 py-2 bg-blue-500 text-white hover:text-white rounded hover:bg-blue-600 transition duration-300 ease-in-out text-lg inline-flex gap-3 items-center justify-center">
              <FaHome />
              <span>Go Home</span>
            </a>
          </Link>
